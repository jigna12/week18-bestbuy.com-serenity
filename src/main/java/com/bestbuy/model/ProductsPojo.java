...
public class ProductsPojo {
    ...
    public static ProductsPojo getProductsPojo(String name, String type, int price, int shipping, String upc, String description, String manufacturer, String model, String url, String image) {
